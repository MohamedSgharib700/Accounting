    ...
    <table class="table table-report text-center -mt-2">
        <thead>
            <tr>
                ...
                <th class="whitespace-no-wrap">كود العميل</th>
            ...
            <tr class="pos-{{$row->id}} intro-x">
                ...
                <td>
                    <div class="text-gray-600 text-xs whitespace-no-wrap">
                        {{$row->customer ? $row->customer->user_code: ''}}
                    </div>
                </td>
...
$(document).ready(function() {
    ...
    $(document).on("click", "#excel", function(e) {
        ...
        $.ajax({
            type: "GET",
            Content: "text/csv",
            url: 'export-customer-agent-pos/' + agentid,
            success: function(data) {
                window.location.href = 'export-customer-agent-pos/' + agentid;
            }
        });
        e.preventDefault();
    });
