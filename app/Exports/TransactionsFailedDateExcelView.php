...
class TransactionsFailedDateExcelView  implements FromView
{
  ...
  public function view() : View
    {
        return view('admin.transactions.excelTransactionFailed', [
            'transactions' => TransactionField::whereDate('created_at', '>=', $this->from_date)->whereDate('created_at', '<=', $this->to_date)
